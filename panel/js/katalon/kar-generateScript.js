...
function getJSONContent() {
  ...
  console.info("Saving to file: " + content);
...
function saveAsFileOfTestCase(fileName, content) {
  ...
  var result = function (id) {
    browser.downloads.onChanged.addListener(function downloadCompleted(
      downloadDelta
    ) {
      if (
        downloadDelta.id == id &&
  ...
  $("#export").click(function () {
    browser.runtime
      ...
      .then(function (externalCapabilities) {
        ...
        Object.keys(externalCapabilities).forEach(function (
          capabilityGlobalId
        ) {
